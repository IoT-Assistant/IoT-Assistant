...
public class WatchdogService implements DeviceVisitor {
	...
	private static int TIME_MINUTES_BETWEEN_OFFLINE_NOTIFICATIONS = 60 * 24; 
	...
	private void sendNotification(Device device) {
		DeviceOfflineNotification offlineNotification = new DeviceOfflineNotification(device, Date.getCurrentDate(), device.getWatchdogInterval());
