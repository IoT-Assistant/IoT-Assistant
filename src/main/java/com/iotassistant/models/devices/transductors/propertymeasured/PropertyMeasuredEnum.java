...
import com.iotassistant.models.devices.transductors.propertymeasured.analog.AnalogBatteryPercentage;
...
import com.iotassistant.models.devices.transductors.propertymeasured.analog.AnalogPH;
...
import com.iotassistant.models.devices.transductors.propertymeasured.analog.AnalogTemperatureFarenheit;
...
import com.iotassistant.models.devices.transductors.propertymeasured.analog.AnalogVoiceAssistantCmdID;
import com.iotassistant.models.devices.transductors.propertymeasured.analog.AnalogVoltageV;
import com.iotassistant.models.devices.transductors.propertymeasured.analog.AnalogWeightGram;
...
public enum PropertyMeasuredEnum implements Property{
	...
	TEMPERATURE_FARENHEIT(new AnalogTemperatureFarenheit()),
	...
	WEIGHT_GRAM(new AnalogWeightGram()),
	...
	PH(new AnalogPH()),
	BATTERY_PERCENTAGE(new AnalogBatteryPercentage()),
	VOICE_ASSISTANT_CMDID(new AnalogVoiceAssistantCmdID()),
