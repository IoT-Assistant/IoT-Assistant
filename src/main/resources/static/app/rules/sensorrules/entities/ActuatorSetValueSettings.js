class ActuatorSetValueSettings {
	...
	isValid() {
		...
		if (allValuesAreSet && this.actuatorProperty.isBinary() && this.actuatorSetValue != 'true' && this.actuatorSetValue != 'false' && this.actuatorSetValue != 'switch') {
	...
	getActuatorSetValueString() {
		if (this.actuatorProperty.isBinary()) {
			let binary = this.actuatorSetValue == 'true' ? "Active" : "Inactive";
			return this.actuatorSetValue == 'switch' ? 'Switch' : binary;
		}
		return this.actuatorSetValue;
	}
